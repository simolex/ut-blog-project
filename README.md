...
Реализовано использование **_feature flags_** с помощью хеллпер функции **_toggleFeatures_**

В функцию параметром передается объект { name, on, off }:
```typescript
toggleFeatures ({
...
Для автоматического удаления фичи можно использовать скрипт **_remove-feature.ts_**
